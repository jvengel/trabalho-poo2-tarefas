...
@Route("concluida")
public class GridProMainConcluida extends Div {

    List<TarefaDTO> database;

    {
        try {
            database = new ArrayList<>(TarefaDAO.listarTarefasConcluida());
    ...
    private void setColumns(GridPro<TarefaDTO> grid) {
        ...
        grid.addEditColumn(GridProMainConcluida::getDataCreation,
                        dataCriacaoRender)
                .custom(datePicker,
