...
@Route("andamento")
public class GridProMainAndamento extends Div {

    List<TarefaDTO> database;

    {
        try {
            database = new ArrayList<>(TarefaDAO.listarTarefasAndamento());
    ...
    private void setColumns(GridPro<TarefaDTO> grid) {
        ...
        grid.addEditColumn(GridProMainAndamento::getDataCreation,
                        dataCriacaoRender)
                .custom(datePicker,
